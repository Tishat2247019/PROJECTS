...
public class Room4 extends JFrame implements ActionListener {
    ...
    public void readroom() {
        try {
            File file = new File("E:\\SUMMER 21-22\\OOP 1\\PROJECT\\HOSTEL MANAGEMENT SYSTEM\\TXTFILES\\Save.txt");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == add && name.getText().isEmpty() == false && id.getText().isEmpty() == false
            ...
            try {
                File file = new File(
                        "E:\\SUMMER 21-22\\OOP 1\\PROJECT\\HOSTEL MANAGEMENT SYSTEM\\TXTFILES\\DataStudent.txt");
                // File myfile = new File("Save.txt");
                FileReader read = new FileReader(file);
                BufferedReader reader = new BufferedReader(read);
                // FileReader read1 = new FileReader(myfile);
                ...
                if (count1 >= 1 && count2 >= 1) {
                    try {
                        File myfile = new File(
                                "E:\\SUMMER 21-22\\OOP 1\\PROJECT\\HOSTEL MANAGEMENT SYSTEM\\TXTFILES\\Save.txt");
                        FileReader read1 = new FileReader(myfile);
                        BufferedReader reader1 = new BufferedReader(read1);
                        String[] wordss = null;
                        String s1 = name.getText();
